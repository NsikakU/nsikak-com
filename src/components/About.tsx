      ...
      <div className="container px-4 mx-auto">
        ...
        >
          ...
          <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
            <p className="bg-gray-50 p-6 rounded-lg shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              ...
              >
                ...
                <p className="text-sm text-gray-600">Building solutions that bridge technology and social impact</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-sm text-gray-600">Creating spaces and opportunities for entrepreneurs to thrive</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-sm text-gray-600">Driving positive change through technology and entrepreneurship</p>
              </motion.div>
            </div>
          </div>
        </motion.div>
